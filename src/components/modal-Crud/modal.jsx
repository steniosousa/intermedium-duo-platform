            ...
            <Box sx={style}>
                ...
                {verb == "Cadastrar" ? (
                    <FormControl fullWidth >
                        <FormControl >
                            ...
                            {path == "manager" ? (
                                <FormControl fullWidth>
                                    ...
                                    <TextField style={{ margin: 5 }} onChange={(event) => setEmail(event.target.value)} id="outlined-basic" label="Email" variant="outlined" />
                        ...
                        <FormControl >
                            <TextField style={{ margin: 5 }} onChange={(event) => setName(event.target.value)} id="outlined-basic" label="Nome" variant="outlined" />


                            <Button variant="contained" onClick={handleCreate}>{isLoading ? (
                    ...
                    <FormControl fullWidth>
                        ...
                        <FormControl >
                            ...
                            <Button variant="contained" onClick={deletionItem}>{isLoading ? (
                                <CircularProgress size={20} />
                            ) : (
                                <span>
                                    Deletar
